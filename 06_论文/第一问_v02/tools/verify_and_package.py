...
STEM = '0910_第一问_药材预热模型_v02_Codex'
...
def main():
    ...
    report = {
        ...
        'mathematical_review': 'Original PDE and nonlinear scheme inherited from reviewed v01; v02 evidence and claims checked against targeted experiments.',
        'inherited_v01_numerical_review': {'status': 'passed_for_v01_only', 'table_cells': 70, 'table_time_labels': 14,
    ...
    archive = PAPER.parent / '0910_第一问_LaTeX源码_v02_Codex.zip'
    included = []
